...
#define LED1_ON                 (NRF_P1->OUTCLR = LED1_MASK)
#define LED1_OFF                (NRF_P1->OUTSET = LED1_MASK)
#define LED1_TOGGLE             (NRF_P1->OUT   ^= LED1_MASK)

#define ANT_SW_ON               (NRF_P1->OUTCLR = ANT_SW_MASK)
#define ANT_SW_OFF              (NRF_P1->OUTSET = ANT_SW_MASK)
...
/* add LED pin defs if you want blinking: e.g. #define LED0_PIN <gpio> */
#ifdef __cplusplus
}
#endif
